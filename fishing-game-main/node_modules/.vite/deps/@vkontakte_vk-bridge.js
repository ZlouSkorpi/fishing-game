...
var _a, _b;
var IS_IOS_WEBVIEW = Boolean(IS_CLIENT_SIDE && ((_b = (_a = window.webkit) == null ? void 0 : _a.messageHandlers) == null ? void 0 : _b.VKWebAppClose));
...
function applyMiddleware(...middlewares) {
  ...
  return (bridge) => {
    ...
    const chain = middlewares.filter((item) => "function" == typeof item).map((middleware) => middleware(middlewareAPI)).reduce((a, b) => (send2) => a(b(send2)));
...
var getLaunchParamsResponseLanguagesSet = /* @__PURE__ */ new Set([
  "ru",
  "uk",
  "ua",
  "en",
...
var getLaunchParamsResponseGroupRoleSet = /* @__PURE__ */ new Set([
  "admin",
  "editor",
  "member",
  "moder",
...
var getLaunchParamsResponsePlatformsSet = /* @__PURE__ */ new Set([
  "desktop_web",
...
var parseURLSearchParamsForGetLaunchParams = (searchParams) => {
  const launchParams = {};
  try {
    ...
    parsedSearchParams.forEach((value, query) => {
      switch (query) {
        ...
        case "vk_is_favorite":
          ...
          break;
        case "vk_language": {
          const validateVKLanguage = (value2) => getLaunchParamsResponseLanguagesSet.has(value2);
          launchParams.vk_language = validateVKLanguage(value) ? value : void 0;
          break;
        }
        case "vk_viewer_group_role": {
          const validateVKViewerGroupRole = (value2) => getLaunchParamsResponseGroupRoleSet.has(value2);
          launchParams.vk_viewer_group_role = validateVKViewerGroupRole(value) ? value : void 0;
          break;
        }
        case "vk_platform": {
          const validateVKPlatform = (value2) => getLaunchParamsResponsePlatformsSet.has(value2);
